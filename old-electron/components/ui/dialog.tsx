  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 duration-200",
          fullScreen
            ? "fixed inset-0 z-50 grid w-screen h-screen translate-x-0 translate-y-0 gap-0 rounded-none border-0 p-0 shadow-none"
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              ...
              fullScreen ? "top-3 right-3" : "top-4 right-4",
            )}
          >
            <XIcon />
